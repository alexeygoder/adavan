...
config_file = 'adavan/config1.ini'
...
def main(input_file,output_dir):
    ...
    print(f"3. Running Parallelized YOLO Inference on Video: {input_video}")
    try:
        yolo_output_dir = "step1_output/annotated_output_parallel.avi" #output_dir + "/" + file_root + ".avi" 
        os.makedirs(yolo_output_dir, exist_ok=True)
        
        run_yolo_sliced_video_parallel(
            input_video_path=input_video,
            model_path="adavan/models/experiments/best.pt",
